...
fn spaceship_movement_controls(
    ...
    // Handle delta seconds in the MovementPlugin
...
fn spaceship_weapon_control(
    ...
    let missile_spawn_transform = Transform::from_translation(
        ...
        command.spawn((
            MovingObjectBundle {
                ...
                model: SceneBundle {
                    ...
                    transform: missile_spawn_transform,
                    ..default()
                },
            },
            SpaceshipMissile,
